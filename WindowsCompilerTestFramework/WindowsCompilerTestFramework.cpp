...
int main()
{
	...
	std::cout << "\nCode 7\n";
	auto [y, z] = compileCodeTest(compilerSystem::Visual_C, code7, (std::string)"C:/Program Files/Microsoft Visual Studio/2022/Preview/VC/Tools/MSVC/14.42.34226/bin/Hostx64/x64/cl", setup, flags, includes3);
	...
	std::cout << "\nCode 8\n";
	auto [c1, d1] = compileCodeTest(compilerSystem::Visual_C, code8, (std::string)"C:/Program Files/Microsoft Visual Studio/2022/Preview/VC/Tools/MSVC/14.42.34226/bin/Hostx64/x64/cl", setup, flags, includes3);
	...
	std::cout << "\nCode 9\n";
	auto [g1, h1] = compileCodeTest(compilerSystem::Visual_C, code9, (std::string)"C:/Program Files/Microsoft Visual Studio/2022/Preview/VC/Tools/MSVC/14.42.34226/bin/Hostx64/x64/cl", setup, flags, includes3);
