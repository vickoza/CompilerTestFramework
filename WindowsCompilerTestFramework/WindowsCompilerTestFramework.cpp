...
int main()
{
	...
	std::cout << "Code 1\n";
	auto [a, b] = compilerCode(compilerSystem::Visual_C, code, (std::string)"C:/Program Files (x86)/Microsoft Visual Studio/2019/Preview/VC/Tools/MSVC/14.28.29812/bin/Hostx86/x86/cl", setup, flags, includes);
	...
	std::cout << "\nCode 2\n";
	auto [e, f] = compilerCode(compilerSystem::Visual_C, code2, (std::string)"C:/Program Files (x86)/Microsoft Visual Studio/2019/Preview/VC/Tools/MSVC/14.28.29812/bin/Hostx86/x86/cl", setup, flags, includes);
	...
	std::cout << "\nCode 3\n";
	auto [i, j] = compilerCode(compilerSystem::Visual_C, code3, (std::string)"C:/Program Files (x86)/Microsoft Visual Studio/2019/Preview/VC/Tools/MSVC/14.28.29812/bin/Hostx64/x64/cl", setup, flags, includes);
	...
	std::cout << "\nCode 4\n";
	auto [m, n] = compilerCode(compilerSystem::Visual_C, code4, (std::string)"C:/Program Files (x86)/Microsoft Visual Studio/2019/Preview/VC/Tools/MSVC/14.28.29812/bin/Hostx64/x64/cl", setup, flags, includes3);
	...
	std::cout << "\nCode 5\n";
	auto [q, r] = compilerCode(compilerSystem::Visual_C, code5, (std::string)"C:/Program Files (x86)/Microsoft Visual Studio/2019/Preview/VC/Tools/MSVC/14.28.29812/bin/Hostx64/x64/cl", setup, flags, includes3);
	...
	std::cout << "\nCode 6\n";
	auto [u, v] = compilerCode(compilerSystem::Visual_C, code6, (std::string)"C:/Program Files (x86)/Microsoft Visual Studio/2019/Preview/VC/Tools/MSVC/14.28.29812/bin/Hostx64/x64/cl", setup, flags, includes3);
	...
	std::cout << "\nCode 7\n";
	auto [y, z] = compilerCode(compilerSystem::Visual_C, code7, (std::string)"C:/Program Files (x86)/Microsoft Visual Studio/2019/Preview/VC/Tools/MSVC/14.28.29812/bin/Hostx64/x64/cl", setup, flags, includes3);
	...
	std::cout << "\nCode 8\n";
	auto [c1, d1] = compilerCode(compilerSystem::Visual_C, code8, (std::string)"C:/Program Files (x86)/Microsoft Visual Studio/2019/Preview/VC/Tools/MSVC/14.28.29812/bin/Hostx64/x64/cl", setup, flags, includes3);
	...
	std::cout << "\nCode 9\n";
	auto [g1, h1] = compilerCode(compilerSystem::Visual_C, code9, (std::string)"C:/Program Files (x86)/Microsoft Visual Studio/2019/Preview/VC/Tools/MSVC/14.28.29812/bin/Hostx64/x64/cl", setup, flags, includes3);
